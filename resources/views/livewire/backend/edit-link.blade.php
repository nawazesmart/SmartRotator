            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="mb-2">
                    <div class="form-check form-switch">
                        <input class="form-check-input" wire:model.live="custom_url" type="checkbox" checked id="flexSwitchCheckDefault">
            ...
            <div class="col-md-8">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-1 mb-1">
                        ...
                        @else
                            @if($item['id'] != null)
                                <button type="button" wire:click="deleteLink('{{$item['id']}}', '{{ $index }}')" class="btn btn-icon btn-outline-danger waves-effect">
